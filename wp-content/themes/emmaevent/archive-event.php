...
<?php //start by fetching the terms for the events taxonomy
...
?>
<?php
// now run a query for each event type
    ...
    <section>
        <div class="container page-events">
            <div class="company__title">
                ...
                <h2 class="page-title">Événements
                    <svg class="icon">
                        ...
                        <div class="content">
                            <figure class="effect-lily">
                                ...
                                <figcaption>
                                    ...
                                    <?php the_excerpt(); ?>
                                    <p class="content-text"><a class="event" href="<?php the_permalink() ?>" title="<?= esc_attr(get_the_title()) ?>">Voir l'événement</a></p>
                                </figcaption>
                            </figure>
                        </div>
