            ...
            <div class="grid">
                <div class="position__left__logo">
                    <a href="<?= home_url('/') ?>" class="nav__logo" title="<?= __('Homepage', 'emmaevent') ?>">
                        <img width="100" height="86" src="<?= get_theme_mod('logo footer') ?>" alt="logo Emma-Event">
                    </a>
                </div>
                ...
                <div class="position__right__credit">
                    <div class="footer__credits">
                        <p>Made with ❤ by <a href="https://priscillaroy.fr" class="developer" target="_blank" rel="noopener noreferrer">Priscilla Roy</a>
                        </p>
                    </div>
                </div>
            </div>
